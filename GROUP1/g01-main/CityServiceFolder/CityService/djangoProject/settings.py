...
MIDDLEWARE = [
    ...
    'cityService.middlewares.UserRoleMiddlerware',
    'cityService.middlewares.LogKafkaMiddleware',
]

REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'cityService.middlewares.custom_exception_handler'
}
